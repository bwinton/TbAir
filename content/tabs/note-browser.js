...
var note = {
  init: function initialize(jQuery, hometab) {
    $ = jQuery;
    $("<li class='menuNote'>notes</li>").appendTo(".features")
      .click( function showNote(event) {
        ...
        hometab.tabmail.openTab("note", { background: background });
      });
  },

  filterNote: function filterNote(event) {
    try {
